		...
		routes: [
			{
				...
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/v2/entries/_slug_/_server.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/v2/_entity_/_value_/_server.js'))
			}
		],
		matchers: async () => {
