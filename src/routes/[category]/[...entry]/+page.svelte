...
<div class="mb-auto flex min-h-screen flex-col justify-start px-4">
  <div
    class="before:content-[' '] relative flex min-h-[50vh] flex-col justify-center grayscale  before:absolute before:top-0 before:-z-0 before:h-full before:w-full before:bg-[rgba(0,0,0,0.5)] lg:min-h-[80vh]"
    style="background-image: url({entry.metadata
      .image}); background-repeat: no-repeat; background-position: right; background-size: contain;"
  >
    <div class="z-10">
      <h1
