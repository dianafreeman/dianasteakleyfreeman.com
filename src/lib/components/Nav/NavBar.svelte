...
<div class="fixed top-0 left-0 right-0 z-50">
  <nav
    ...
    class="relatve w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
  >
    ...
    {#if $mobileMenuOpen}
      <hr class="my-5" />
        <div
          transition:slide
          id="main-menu"
          class="relative left-0 px-2 pb-3 w-full bg-neutral-900 z-50 md:relative md:flex"
        ...
        >
          ...
          >
            Dyslexia Font
            <button aria-pressed="true" class="hover:bg-neutral-600">
  Toggle On
            </button>
          </p>
